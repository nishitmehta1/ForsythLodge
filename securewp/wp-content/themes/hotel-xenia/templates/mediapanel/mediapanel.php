...
# TYPE(S): Default / Color / Image
# DESCRIPTION: 	The default media panel. Displayed on 'color' type
...
<div class="{{ hgroup_container }}">
    ...
    <div class="hgroup {{ hgroup_textalign }} {{ hgroup_width }} {{ hgroup_style }}">
      ...
      <div class="ple_breadcrumb_wrapper {{ colorset }} transparent neutralize_links">{{{ hgroup_breadcrumb }}}</div>
    </div>
  {{/ hgroup }}
</div>