...
<div id="{{ grid_id }}" class="grid_wrapper list_grid row clearfix">	
        {{# items }}
        <div class="blog_post_listed grid_item col-xs-12 {{# item_filter_classes }} {{ filter_class }}{{/ item_filter_classes }}{{# item_term_classes }} {{ term_class_slug }}{{/ item_term_classes }} {{ item_attr_extraclass }}">
        <div class="blog_post_listed_wrapper">
                <div class="blog_post_listed_meta">
                        ...
                        {{# item_title }}<h3 class="textify_links">{{# item_link }}<a href="{{ item_link }}" target="{{ item_link_target }}" class="{{ item_link_class }}">{{/ item_link }}{{{ item_title }}}{{# item_link }}</a>{{/ item_link }}</h3>{{/ item_title }}
