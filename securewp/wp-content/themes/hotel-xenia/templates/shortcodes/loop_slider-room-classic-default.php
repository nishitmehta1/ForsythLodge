...
*/
?>
<div id="{{ grid_id }}" class="rooms_slider_classic_wrapper {{ el_class }}">   
    {{# items }}
        <div class="rooms_list_item {{# item_filter_classes }} {{ filter_class }}{{/ item_filter_classes }}{{# item_term_classes }} {{ term_class_slug }}{{/ item_term_classes }} {{ item_colorset }} {{ item_attr_extraclass }}" >
        <div class="flex">
