	...
	var Grid = (function() {
		...
		Preview.prototype = {
			create : function() {
				...
				this.$title        = jQuery( '<h2></h2>' );
				this.$description  = jQuery( '<p></p>' );
				this.$online   = jQuery( '<div class="online_demo"></div>' );
				this.$plugins      = jQuery( '<div class="plugin_items"></div>' );
				this.$importdemo   = jQuery( '<div class="importdemo_panel"></div>' );
				this.$details      = jQuery( '<div class="og-details"></div>' ).append( this.$title, this.$description, this.$online, this.$plugins, this.$importdemo );
