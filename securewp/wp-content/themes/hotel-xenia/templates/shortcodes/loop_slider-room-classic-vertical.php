...
*/
?>
<div id="{{ grid_id }}" class="grid_wrapper {{ gutter }} rooms_grid_classic_vertical_wrapper {{ el_class }}"> 	
	{{# items }}
        <div class="rooms_grid_item grid_item {{ item_attr_class }} {{# item_filter_classes }} {{ filter_class }}{{/ item_filter_classes }}{{# item_term_classes }} {{ term_class_slug }}{{/ item_term_classes }} {{ item_attr_extraclass }}" >
