...
*/
?>
<div id="{{ grid_id }}" class="grid_wrapper strict_grid row clearfix">    
        {{# items }}
        <div class="blog_post_card blog_post_listed grid_item {{ item_attr_class }} col-xs-12 {{# item_filter_classes }} {{ filter_class }}{{/ item_filter_classes }}{{# item_term_classes }} {{ term_class_slug }}{{/ item_term_classes }}">
        <div class="blog_post_listed_wrapper {{ item_attr_extraclass }}">
                ...
                <div class="blog_post_listed_texts {{ item_colorset }}">
