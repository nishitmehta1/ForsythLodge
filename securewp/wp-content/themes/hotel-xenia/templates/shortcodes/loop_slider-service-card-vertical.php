...
*/
?>
<div id="{{ grid_id }}" class="grid_wrapper row clearfix {{ gutter }} services_grid_card_vertical_wrapper {{ el_class }}"> 	
	{{# items }}
        <div class="services_grid_item grid_item grid_sizer col-xs-12 {{ item_attr_class }} {{# item_filter_classes }} {{ filter_class }}{{/ item_filter_classes }}{{# item_term_classes }} {{ term_class_slug }}{{/ item_term_classes }} {{ item_attr_extraclass }}" >
                ...
                <div class="services_grid_item_content {{ item_colorset }}">
                        ...
                        {{# item_link }}<a href="{{ item_link }}" title="{{ item_title }}" target="{{ item_link_target }}" class="btn btn-primary {{ item_link_class }}">{{{ item_link_label }}}</a>{{/ item_link }}
                </div>
